...
const Login = () => {
  ...
  return (
    <div className=" flex flex-col md:flex-row align-middle justify-center min-h-[50vh] w-full ">
      ...
      {/* logo */}
      <div className="absolute top-[15%] left-[30%] sm:top-[10%] font-sans space-y-2  flex flex-col justify-center items-center ">
      ...
      >
        ...
        <div className="relative w-full sm:w-[90%] flex flex-col">
          <label
            htmlFor="password"
            className={`${errors.password ? "text-red-600" : "text-[#7A7A7A]"}`}
          >
            Password{" "}
          </label>
          <input
