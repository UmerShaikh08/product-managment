  ...
  return (
    <>
      <div
        className={`${
          showDemo ? "" : "hidden"
        } justify-center items-center absolute bg-[#81ECFF] top-28 md:top-32 md:right-[50%] right-[10%] p-6 -rotate-[20deg] z-20 `}
      >
        ...
        >
          ...
          >
            {loading ? (
              <>
                <svg
                  className="animate-spin flex items-center justify-center m-0   w-[20%] text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
